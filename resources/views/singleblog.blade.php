				...
				<div class="row">
					<div class="col-lg-12 mb-5">
						<div class="single-blog-item">
							<img loading="lazy" src="{{ asset('storage/'. $post->photo) }}" alt="blog" class="img-fluid rounded">
							...
							<div class="blog-item-content bg-white p-5">
								<div class="blog-item-meta bg-gray pt-2 pb-1 px-3">
									...
									<span class="text-black text-capitalize mr-3"><i class="ti-time mr-1"></i>{{ date('d M', strtotime($post->created_at)) }}</span>
								</div>
				...
				<div class="sidebar-wrap">
					...
					<div class="sidebar-widget latest-post card border-0 p-4 mb-3">
                        ...
                        @foreach ($posts as $allPost)
							...
							<a href="{{ url('/blog') }}/{{ $allPost->id }}"><img loading="lazy" style="width: 50px" class="mr-4" src="{{ asset('storage/'.$allPost->photo) }}" alt="blog"></a>
							<div class="media-body">
								<h6 class="my-2"><a href="{{ url('/blog') }}/{{ $allPost->id }}">{{ $allPost->title }}</a></h6>
								<span class="text-sm text-muted">{{ date('d M Y', strtotime($allPost->created_at)) }}</span>
							</div>
						    </div>
                        @endforeach
